...
pcl::PointCloudpcl::PointXYZ cloud_a, cloud_b, cloud_c;
pcl::PointCloudpcl::Normal n_cloud_b;
pcl::PointCloudpcl::PointNormal p_n_cloud_c;
...
if (strcmp(argv[1], "-p") for ( == 0std::size_t i = 0; i)
< cloud_b.size (); ++i)
